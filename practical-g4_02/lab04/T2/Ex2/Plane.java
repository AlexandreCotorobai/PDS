...
public class Plane {
	 private ClassPlane classPlane;
	    ...
	    public Plane(String confT, String confE) {
	        ...
	        if (confE != "") {
	            this.classPlane = ClassPlane.TURISTICA_EXECUTIVA;
	    ...
	    public ClassPlane getClassPlane() {
	        return this.classPlane;
	    }

	    public void setClassAviao(ClassPlane classPlane) {
	        this.classPlane = classPlane;
	    }
	    
	    public void setConfAviao(ClassPlane classe) {
	        this.classPlane = classe;
	    }
	    ...
	    public void makeReservation(Reserva reservation) {
	        int freeInRow = 0;
	        int seatToStart = 0;
	        if (reservation.getClassName() == ClassPlane.TURISTICA) {
	        ...
	        else if (reservation.getClassName() == ClassPlane.EXECUTIVA) {
	    ...
	    public int hashCode() {
	        final int prime = 31;
	        int result = 1;
	        result = prime * result + ((classPlane == null) ? 0 : classPlane.hashCode());
	        return result;
	    }
	    ...
	    public boolean equals(Object obj) {
	        ...
	        if (classPlane != other.classPlane)
	            return false;
	        return true;
	    }
	    ...
	    public String toString() {
	        return "Aviao [classPlane=" + classPlane + "]";
	    }
